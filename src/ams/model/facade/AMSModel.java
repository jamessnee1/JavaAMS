...
public interface AMSModel {
	...
	/**
	 * throws exception if courses specified as prereqs for newCourse do not
	 * exist
	 */
	public void addCourse(Course course) throws ProgramException;

	/**
	 * throws exception if the course to be removed is a prereq for the other
	 * course/s
	 */
	...
	// returns the total number of credit points for all currently enrolled
	// courses
	public int calculateCurrentLoad();

	// returns the total number of credit points for all completed (passed)
	// courses
