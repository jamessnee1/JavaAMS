...
/**
 * <b>Programming 2, Assignment 1 Part B</b><br/>
 * 
...
public class TestHarness {
	...
	private static Course electiveCourse1, electiveCourse2, electiveCourse3,
			electiveCourse4;
	...
	// this method is used only when checking the overload condition upon course
	// enrollment
	public static void initialiseCoursesWithNoPrereqs() {
		...
		electiveCourse4 = new ElectiveCourse(ADV_DISTRIBUTED2,
				"Advanced Topics in Distributed Systems 2", 12, null);
	}
	...
	public static boolean test12() throws Exception {
		...
		try {
			...
			// exception should be thrown because one of the prereqs is not
			// passed
			try {
				System.out.println("Enrolling student into third course...");
				model.enrollIntoCourse(COMP_THEORY);
	...
	public static boolean test13() throws Exception {
		...
		try {
			...
			// exception should be thrown due to overload since there is failed
			// course
			try {
				System.out
